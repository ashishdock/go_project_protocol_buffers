...
type Complex struct {
	...
	One_Dummy       *Dummy   `protobuf:"bytes,1,opt,name=one_Dummy,json=oneDummy,proto3" json:"one_Dummy,omitempty"`
...
func (x *Complex) GetOne_Dummy() *Dummy {
	if x != nil {
		return x.One_Dummy
	}
	return nil
...
var file_complex_proto_rawDesc = []byte{
	...
	0x5f, 0x44, 0x75, 0x6d, 0x6d, 0x79, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x16, 0x2e, 0x65,
	...
	0x73, 0x42, 0x12, 0x5a, 0x10, 0x61, 0x73, 0x68, 0x69, 0x73, 0x68, 0x2e, 0x63, 0x6f, 0x6d, 0x2f,
